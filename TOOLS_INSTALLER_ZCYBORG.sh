...
while [ $lagi -lt 6 ];
do
echo "SEBELUM KE TOOLS NYA MASUKAN PASSWORD DULU!!"
echo "UNTUK MENDAPATKAN PASSWORD NYA" | lolcat
echo "LINK:" | lolcat
echo "https://bercara.com/7oML21aE" | lolcat
echo ""
echo "WARNING! PERTANYAAN TENTANG PASSWORD" | lolcat
echo "TIDAK AKAN DI RESPON SI PEMBUAT!!" | lolcat
echo "PASSWORD AKAN DI GANTI SETIAP BULAN!!" | lolcat
echo ""
echo -n 'Masukkan Password Anda : '
read pw;

if [ $pw = 'MANTAP123KAU321' ];
then
    echo 'Password anda benar' | lolcat
else
    echo 'Password anda salah' | lolcat
    echo 'Silakan Masukkan kembali' | lolcat
    exit
fi

echo  "_____________________________________________________________" | lolcat

toilet -f pagga "   ZCYBORG"|lolcat

echo  "_____________________________________________________________" | lolcat

echo  "_____________________________________________________________" | lolcat
echo  "[TYPE      : TOOLS INSTALLER] " |lolcat
echo  "[NAME      : TOOLS-ZCY-v5"
echo  "[VERSION   : V.5] " | lolcat
echo  "[TOTALS    : BANYAK SEKALI!] " | lolcat
echo  "[AUTHOR    : Zcyb0RG] " | lolcat
echo  "[INSTAGRAM : random_para.tolol] " |lolcat
echo  "[INSTAGTAM2: zcyborg__] " |lolcat
echo  "[NOTES     : ANDA TIDAK BISA RECODE TOOLS INI!] " | lolcat
...
echo  $green"TERIMA KASIH UDAH MAU MAKEK TOOLS GW!!!" | lolcat
echo  $green"SALAM ZCYBORG WE ARE FAMILY" | lolcat
sleep 1
exit
}
echo ""
...
echo  "CONTOH : cd namatool DAN SETERUSNYA!" | lolcat
...
echo ""
echo -e "============================" | lolcat
echo -e "1000.CHAT ADMIN VIA WA" | lolcat
echo -e "============================" | lolcat
...
404) clear
git clone https://github.com/ZCYBORG-404/DARK-FB-VIP
;;
...
H) clear
echo "_____________________________________________________________" | lolcat
echo "TOOLS INI DI BUAT OLEH Zcyb0RG" | lolcat
echo "_____________________________________________________________" | lolcat
echo "TOOLS INI DI CIPTAKAN UNTUK MEMBANTU NEWBIE YANG SUKA MINTA SC" | lolcat
echo "_____________________________________________________________" | lolcat
echo "DI CIPTAKAN PADA 30/8/2019" | lolcat
echo "_____________________________________________________________" | lolcat
...
echo "_____________________________________________________________" | lolcat
echo "INSTAGRAM: random_para.tolol (KHUSUS MEME)" | lolcat
echo "_____________________________________________________________" | lolcat
echo "INSTAGRAM 2 : zcyborg__" | lolcat
echo "_____________________________________________________________" | lolcat
echo "NOTE: BELAJAR MENJADI HACKER GAMPANG YANG PENTING NIAT DAN USAHA" | lolcat
echo "_____________________________________________________________" | lolcat
echo ""
...
00) echo "AUTHOR Zcyb0RG"
echo "MENGUCAPKAN"
echo "TERIMA KASIH"
echo "TELAH MEMAKAI TOOLS GW"
exit
;;
1000) clear
xdg-open https://api.whatsapp.com/send?phone=6281238585212
;;
*) echo "PILIHAN MU GAK ADA VOSS!!"
esac
done
done
